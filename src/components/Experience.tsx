...
const experiences = [
  {
    ...
    description: (
      <ul className="list-disc list-inside">
        <li>Developing responsive user interfaces using HTML, CSS, JavaScript (ES6), TypeScript, and modern frameworks like React.js (with Vite & Tailwind CSS)</li>
      </ul>
    ),
  ...
  },
  {
    ...
    description: (
      <ul className="list-disc list-inside">
        <li>Contributed to building AI agents for Twitter Spaces by integrating LLMs (OpenAI, Google Gemini, AssemblyAI) and developing APIs using web scraping of space data</li>
        <li>Built and deployed full-stack features with Next.js, including payment integration and an authenticated backend using Supabase</li>
      </ul>
    ),
  ...
  },
  {
    ...
    description: (
      <span>
        Speech Enhancement using U-Net architecture: Developed a U-Net-based deep learning model to enhance speech by removing background noise using spectrogram learning.
      </span>
    ),
...
const Experience = () => (
  <section className="relative bg-[#d72660] min-h-screen flex flex-col items-center justify-center overflow-hidden">
    ...
    {/* Top bumps (absolute, overlays and cuts into red) */}
    ...
    {/* Bottom bumps (absolute, overlays and cuts into red) */}
    ...
    {/* Padding so content doesn't get hidden by the SVG */}
    <div className="max-w-7xl mx-auto relative z-20 pt-[48px] pb-[48px] py-20 px-4 sm:px-6 lg:px-8 w-full">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-white/90 max-w-3xl mx-auto animate-fadeInUp animation-delay-200">
      ...
      <div className="space-y-8">
        {experiences.map((exp, index) => (
          <div
            key={index}
            className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 animate-slideInUp"
          ...
          >
            ...
            <div className="text-gray-600 mb-6 leading-relaxed">{exp.description}</div>
